(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-sort-search-table", [], factory);
	else if(typeof exports === 'object')
		exports["react-sort-search-table"] = factory();
	else
		root["react-sort-search-table"] = factory();
})(this, function() {
	...
	SortableTblPager.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'button', className: 'btn btn-warning', name: '', disabled: prevDisableStyle,
					onClick: this.subPage, value: '<' }),
				_react2.default.createElement(
					'div',
					{ onClick: this.setCurrentPage, value: this.state.currPage, className: 'form-control page-select' },
				...
				_react2.default.createElement('input', { type: 'button', className: 'btn btn-warning', name: '', disabled: nextDisableStyle,
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/index.js!./SortableTbl.scss", function() {
			var newContent = require("!!../node_modules/css-loader/index.js!../node_modules/sass-loader/index.js!./SortableTbl.scss");
...
var _SortableTblPager = __webpack_require__(22);

var _SortableTblTh = __webpack_require__(24);

var _SortableTblTd = __webpack_require__(23);
...
var SortableTbl = function (_React$Component) {
	...
	function SortableTbl(props) {
		...
		_this.setCurrentPage = _this.setCurrentPage.bind(_this);
		_this.setRowsPerPage = _this.setRowsPerPage.bind(_this);
		if (props.defaultCSS === true) __webpack_require__(26);
	...
	SortableTbl.prototype.filter = function filter(e) {
		var newData = this.props.tblData.filter(function (item) {
			for (var key in item) {
				var v = item[key] && item[key].toString().toLowerCase();
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				this.props.search && _react2.default.createElement(
					...
					_react2.default.createElement('input', { className: 'search', type: 'text', name: '', value: this.state.filter, placeholder: 'Search', onChange: this.filter })
				),
...
SortableTbl.propTypes = {
	...
	defaultCSS: _react2.default.PropTypes.bool,
...
//# sourceMappingURL=react-sort-search-table.js.map